...
We can look at the converted files and compare the nameing scheme and storage requirements to the original CSV data.
...
dbFetch(y)
```
The main advantages of `duckdb` are that it has full SQL support and is optimized for speed.
